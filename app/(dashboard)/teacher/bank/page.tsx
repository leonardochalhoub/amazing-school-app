    ...
    <div className="space-y-6 pb-16">
      ...
      <header className="flex flex-col gap-1">
        ...
        <p className="text-sm text-muted-foreground">
          Reusable exercise blocks. Mark any item <em>public</em> to share it
          with other teachers — they can import your exercises into their own
          lessons. Popular items rise to the top.
        </p>
      </header>
