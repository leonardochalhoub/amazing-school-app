...
export default async function TeacherProfilePage() {
  ...
  return (
    <div className="mx-auto w-full max-w-5xl space-y-6 pb-10">
      ...
      {/* Curriculum PDF generator — same shape as the student's
          MyDocumentsCard (YearSelector + Download button). Seed
          dates come from the profile's created_at so the year list
          starts from the teacher's first day on the platform. */}
